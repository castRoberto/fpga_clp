...
HD_PWD='C:/LSE/bimestre_4/fpga/fpga_clp/codigos/sumNb_VIO/synthesis/sumNb_VIO/sumNb_VIO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumNb_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumNb_VIO.tcl
