...
HD_PWD='C:/LSE/bimestre_4/fpga/fpga_clp/codigos/sumNb_VIO/synthesis/sumNb_VIO/sumNb_VIO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sumNb_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sumNb_VIO.tcl -notrace
